    ...
    <div className='overflow-hidden'>
      ...
      <div>
        <div className='flex flex-row justify-between mt-5 h-60 w-full border-2 border-black rounded-t-3xl' style={divStyle}>
          ...
          <div className='bg-[#FDCEDF] mt-3 ml-2 py-1.5 font-semibold flex items-center text-center justify-evenly border-2 border-black rounded-3xl w-[50%] h-[15%]'>
            ...
            <button className='border-2 border-black rounded-3xl w-20 h-9 bg-[#FDCEDF] mt-3 mr-2 font-medium '>100+</button>
        </div>
      </div>
   


      <div className='bg-[#C1EFFF] items-center pb-2 pl-1 font-semibold flex flex-row w-100 h-36 border-x-2 border-b-2 rounded-b-3xl border-black'>
        <div className='items-center'>
          ...
          <div className='text-xs pl-3 pr-4 pt-2 font-normal '>
            <p className='line-clamp-4'>
              ...
              asu lorem ipsum lorem ipsum aru kiba kibi likhi asu lorem ipsum lorem ipsum aru kiba kibi likhi as. ipsum aru kiba kibi likhi
