    ...
    <div className="overflow-hidden">
      <div>
        <div
          ...
          style={divStyle}
        >
          <div className="ml-2 mt-3 flex h-[15%] w-[50%] items-center justify-evenly rounded-3xl border-2 border-black bg-[#FDCEDF] py-1.5 text-center font-semibold">
            <div>
              <img
          ...
          <button className="mr-2 mt-3 h-9 w-20 rounded-3xl border-2 border-black bg-[#FDCEDF] font-medium ">
            100+
          </button>
        </div>
      </div>

      <div className="w-100 flex h-36 flex-row items-center rounded-b-3xl border-x-2 border-b-2 border-black bg-[#C1EFFF] pb-2 pl-1 font-semibold">
