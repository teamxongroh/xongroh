      ...
      <div className='bg-[#FFDEB4]'>
        <div className='flex flex-col'>
          ...
          <div className='header px-3 pt-5 pb-5 bg-[#F0D9FF] rounded-b-3xl flex flex-col items-center'>
              ...
              <div className='font-bold'>Mahindra alpha beta</div>
              <p className=' px-5 py-5 text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id felis a est dapibus posuere. Donec molestie risus ac elit imperdiet pretium. Phasellus volutpat nec ligula at accumsan.</p>
              <div className='flex flex-row'>
